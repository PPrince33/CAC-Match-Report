...
const handleEventClick = (timeSecs) => {
  const seekTime = Math.max(0, timeSecs - 5);
  ...
  const handleDownloadPDF = () => {
    ...
    setTimeout(() => {
      try {
        ...
        // PAGE: ANALYST NOTES
        doc.addPage(); y = M;
        addText('5. ANALYST NOTES', M, 11, { style: 'bold' }); y += 8;
        drawLine(M, y - 3, M + pw, y - 3, '#000000', 0.5);
    ...
    <div className="min-h-screen bg-white font-mono relative overflow-x-hidden">
      ...
      {isGeneratingPDF && (
        ...
        <div id="pdf-report-container" className="bg-white p-8 font-mono text-black print-container" style={{ width: '800px', maxWidth: '800px' }}>
          ...
          {/* PDF Section: Distribution Pitches */}
        ...
        {loading || !stats ? (
          ...
          <>
              ...
              <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <section className="pt-8 border-t-4 border-dashed border-gray-200">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    <AveragePositionsPitch data={avgHomeData} teamName={match.home_team?.team_name} isHome={true} lineups={lineups} />
                    <AveragePositionsPitch data={avgAwayData} teamName={match.away_team?.team_name} isHome={false} lineups={lineups} />
                  </div>
                </section>
              </div>
            )}
              ...
              <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <section className="mb-10">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 gap-2">
                    ...
                    <div className="flex flex-col items-end gap-1">
                      <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-tight">* Dot size indicates xG value</span>
                ...
                <section className="mb-10 border-t-4 border-dashed border-gray-200 pt-8">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 gap-2">
                    ...
                    <div className="flex flex-col items-end gap-1">
                      <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-tight">* Based on end coordinates (y, z)</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                  <BrutalistCard color="bg-white">
                    <h3 className="text-sm font-black uppercase bg-black text-white p-2 mb-4 flex items-center gap-2"><Crosshair size={16} /> Shooting & Efficiency</h3>
                    <div className="flex flex-col">{renderStatRows('attack_shooting', attackStats.home, attackStats.away)}</div>
                  </BrutalistCard>

                  <BrutalistCard color="bg-[#f8fafc]">
                    <h3 className="text-sm font-black uppercase bg-black text-[#FFD166] p-2 mb-4 flex items-center gap-2"><Activity size={16} /> Distribution & Creativity</h3>
                    <div className="flex flex-col">{renderStatRows('attack_distribution', attackStats.home, attackStats.away)}</div>
                  </BrutalistCard>

                  <BrutalistCard color="bg-white">
                    <h3 className="text-sm font-black uppercase bg-black text-white p-2 mb-4 flex items-center gap-2"><Zap size={16} /> Ball Progression</h3>
                    <div className="flex flex-col">{renderStatRows('attack_ball_progression', attackStats.home, attackStats.away)}</div>
                  </BrutalistCard>

                  <BrutalistCard color="bg-[#f8fafc]">
                    <h3 className="text-sm font-black uppercase bg-black text-[#FFD166] p-2 mb-4 flex items-center gap-2"><Shield size={16} /> Performance Under Pressure</h3>
                    <div className="flex flex-col">{renderStatRows('attack_pressure', attackStats.home, attackStats.away)}</div>
                  </BrutalistCard>
                </div>
              </div>
            )}
            ...
            {activeTab === 'DEFENSE' && defenseStats && (
              <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="border-b-4 border-black pb-2 mb-6 flex items-center justify-between">
                  <h2 className="text-3xl font-black uppercase tracking-tighter flex items-center gap-3"><Shield size={32} /> Defensive KPIs</h2>
                </div>
                ...
                <section className="mb-10">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 gap-2">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-tight mt-1">* Kernel Distribution: Tackles, Interceptions, Blocks, & Saves</span>
                    </div>
                    <div className="flex flex-col md:flex-row items-start md:items-end gap-4 w-full md:w-auto mt-4 md:mt-0">
                      <div className="flex flex-col items-start gap-1 w-full md:w-auto">
                        ...
                        <select className="border-2 border-black p-2 font-bold uppercase text-xs focus:bg-[#FFD166] outline-none shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] w-full md:w-48 cursor-pointer" value={defActionFilter} onChange={handleDefActionChange}>
                          <option value="ALL">All Actions</option>
                      ...
                      <div className="flex flex-col items-start gap-1 w-full md:w-auto">
                        ...
                        <select className="border-2 border-black p-2 font-bold uppercase text-xs focus:bg-[#FFD166] outline-none shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] w-full md:w-48 cursor-pointer" value={defOutcomeFilter} onChange={(e) => setDefOutcomeFilter(e.target.value)}>
                          <option value="ALL">All Outcomes</option>
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    <HeatmapPitch events={enrichedEvents.filter(e => e.team_id === match.home_team_id && (defActionFilter === 'ALL' ? defActions.includes(e.action) : e.action === defActionFilter) && (defOutcomeFilter === 'ALL' || e.outcome === defOutcomeFilter))} teamName={match.home_team?.team_name} isHome={true} />
                    <HeatmapPitch events={enrichedEvents.filter(e => e.team_id === match.away_team_id && (defActionFilter === 'ALL' ? defActions.includes(e.action) : e.action === defActionFilter) && (defOutcomeFilter === 'ALL' || e.outcome === defOutcomeFilter))} teamName={match.away_team?.team_name} isHome={false} />
                  </div>
                </section>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                  <BrutalistCard color="bg-white">
                    <h3 className="text-sm font-black uppercase bg-black text-white p-2 mb-4 flex items-center gap-2"><Zap size={16} /> Tackling & Interceptions</h3>
                    <div className="flex flex-col">{renderStatRows('defense_tackling', defenseStats.home, defenseStats.away)}</div>
                  </BrutalistCard>

                  <BrutalistCard color="bg-[#f8fafc]">
                    <h3 className="text-sm font-black uppercase bg-black text-[#FFD166] p-2 mb-4 flex items-center gap-2"><Shield size={16} /> Blocks & Clearances</h3>
                    <div className="flex flex-col">{renderStatRows('defense_blocks', defenseStats.home, defenseStats.away)}</div>
                  </BrutalistCard>

                  <BrutalistCard color="bg-white">
                    <h3 className="text-sm font-black uppercase bg-black text-white p-2 mb-4 flex items-center gap-2"><RefreshCw size={16} /> Work Rate & Recoveries</h3>
                    <div className="flex flex-col">{renderStatRows('defense_work_rate', defenseStats.home, defenseStats.away)}</div>
                  </BrutalistCard>

                  <BrutalistCard color="bg-[#f8fafc]">
                    <h3 className="text-sm font-black uppercase bg-black text-[#FFD166] p-2 mb-4 flex items-center gap-2"><ClipboardList size={16} /> Goalkeeping & Discipline</h3>
                    <div className="flex flex-col">{renderStatRows('defense_goalkeeping', defenseStats.home, defenseStats.away)}</div>
                  </BrutalistCard>
                </div>
              </div>
            )}
            ...
            {activeTab === 'PLAYER' && p1Data && p2Data && (
              <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="border-b-4 border-black pb-2 mb-6 flex items-center justify-between">
                  <h2 className="text-3xl font-black uppercase tracking-tighter flex items-center gap-3"><Users size={32} /> Player Analysis & Comparison</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                  <BrutalistCard color="bg-[#f8fafc]" className="border-[#0077B6]">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex gap-2">
                        <select className="w-1/3 border-2 border-[#0077B6] p-2 font-bold uppercase text-[10px] focus:bg-[#0077B6] focus:text-white outline-none cursor-pointer" value={p1TeamId} onChange={(e) => setP1TeamId(e.target.value)}>
                        ...
                        <select className="w-2/3 border-2 border-[#0077B6] p-2 font-bold uppercase text-xs focus:bg-[#0077B6] focus:text-white outline-none cursor-pointer" value={p1PlayerId || ''} onChange={(e) => setP1PlayerId(e.target.value)}>
                          {p1Options.map(p => (
                            <option key={p.player_id} value={p.player_id}>#{p.jersey_no || '-'} {p.players?.player_name} ({p.players?.position || 'N/A'})</option>
                          ))}
                        </select>
                      </div>
                    </div>
                  ...
                  <BrutalistCard color="bg-[#f8fafc]" className="border-[#D90429]">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex gap-2">
                        <select className="w-1/3 border-2 border-[#D90429] p-2 font-bold uppercase text-[10px] focus:bg-[#D90429] focus:text-white outline-none cursor-pointer" value={p2TeamId} onChange={(e) => setP2TeamId(e.target.value)}>
                          <option value={match.home_team_id}>{match.home_team?.team_name}</option>
                          <option value={match.away_team_id}>{match.away_team?.team_name}</option>
                        </select>
                        <select className="w-2/3 border-2 border-[#D90429] p-2 font-bold uppercase text-xs focus:bg-[#D90429] focus:text-white outline-none cursor-pointer" value={p2PlayerId || ''} onChange={(e) => setP2PlayerId(e.target.value)}>
                          {p2Options.map(p => (
                            <option key={p.player_id} value={p.player_id}>#{p.jersey_no || '-'} {p.players?.player_name} ({p.players?.position || 'N/A'})</option>
                          ))}
                        </select>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                  <BrutalistCard color="bg-white">
                    ...
                    <div className="text-center mt-4">
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-tight">* Chart scaled relative to the highest match values</span>
                    </div>
                  </BrutalistCard>
            ...
            {activeTab === 'HIGHLIGHTS' && (
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="border-b-4 border-black pb-2 mb-6 flex items-center justify-between">
                  <h2 className="text-3xl font-black uppercase tracking-tighter flex items-center gap-3"><Video size={32} /> Video Highlights & Replay</h2>
                </div>
